          ...
          >
            ...
            <div className="row g-3 mb-9">
              <div className="col-md-6">
                ...
                >
                  <img alt="Logo" src="/img/google-icon.svg" className="h-15px me-3" />
                  Sign in with Google
                </a>
              </div>
              <div className="col-md-6">
            ...
            <div className="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
              <div></div>
              <a
                href="../../demo44/dist/authentication/layouts/creative/reset-password.html"
            ...
            <div className="text-gray-500 text-center fw-semibold fs-6">
              Not a Member yet?
              <a
                href="../../demo44/dist/authentication/layouts/creative/sign-up.html"
                className="link-primary"
              >
                Sign up
              </a>
